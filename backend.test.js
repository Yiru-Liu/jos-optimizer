...
describe("maxCheapest", () => {
    ...
    test("oneCart when parameter does not have the minimum cheapest", () => {
        expect(() => oneCart.maxCheapest([1])).toThrow("Cart does not have minimum of cheapest (expected 0, got 1)");
    });
    ...
    test("twoPerfect when parameter does not have the minimum cheapest", () => {
        expect(() => twoPerfect.maxCheapest([1])).toThrow("Cart does not have minimum of cheapest (expected 0, got 1)");
        expect(() => twoPerfect.maxCheapest([2])).toThrow("Cart does not have minimum of cheapest (expected 0, got 2)");
    });
